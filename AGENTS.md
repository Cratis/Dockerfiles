# Dockerfiles — Project Instructions

## Repository scope and rule routing

Infrastructure profile: shared Docker images and build workflows, not an application. Use affected Dockerfile/workflow checks; image publication requires separate exact authorization.
